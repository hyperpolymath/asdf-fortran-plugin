...
:url-repo: https://github.com/hyperpolymath/asdf-fortran-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-fortran-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-fortran-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-fortran-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Fortran] versions.
...
Fortran is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Fortran versions per project

|**Project Isolation**
|Pin Fortran per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Fortran version
...
=== Installing Fortran Versions

[source,bash]
----
asdf list all fortran
asdf install fortran latest
asdf install fortran 0.1.0
----
...
[source,bash]
----
asdf global fortran 0.1.0
asdf local fortran 0.1.0
asdf current fortran
fortran --version
----
...
* Ensure `fortran` is on PATH after installation.
* Verify the installed version with `fortran --version`.
